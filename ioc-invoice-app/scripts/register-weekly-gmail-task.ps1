# Registers a Windows Task Scheduler job to run weekly Gmail sync every Sunday at 6:00 AM.
...
Write-Host "Registered task '$taskName' — Sundays at 6:00 AM local time."
